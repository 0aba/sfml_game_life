...
unsigned short my_gui::ContextMenu::createElement()
{
    this->elements.push_front( new ContextMenuElement (*this->getWindow(),
                                          ...
                                          "default",
                                          this,
                                          [](my_gui::OBJECT_GUI* contextCalled, ContextMenuElement* thisElement) { },
...
unsigned short my_gui::ContextMenu::createElement(char *pathBackgroundTexture,
                                                 ...
                                                 char *pathFont,
                                                 sf::String text,
                                                 my_gui::OBJECT_GUI* contextCalled,
                                                 void (*clickEvent)(my_gui::OBJECT_GUI* contextCalled, ContextMenuElement* thisElement),
                                                 sf::Color textColor,
                                                 sf::Color idleColor,
                                                 sf::Color hoverColor,
